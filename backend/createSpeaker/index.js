// Topic Endpoint: https://johan-serverless-eventgrid.westeurope-1.eventgrid.azure.net/api/events
...
function publishToEventGrid(speaker) {
    ...
    const topicHostName =
        'https://johan-serverless-eventgrid.westeurope-1.eventgrid.azure.net/api/events';
